...
type DomainDetails struct {
	...
	ContactAdmin           ContactsInterface `json:"contactAdmin,omitempty"`
	ContactBilling         ContactsInterface `json:"contactBilling,omitempty"`
	ContactRegistrant      ContactsInterface `json:"contactRegistrant,omitempty"`
	ContactTech            ContactsInterface `json:"contactTech,omitempty"`
